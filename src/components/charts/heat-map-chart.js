...
import HeatMapExpanded from './heat-map-chart-expanded';
...
export default class Chat extends Component {
  ...
  montChart() {
    ...
    const chart = am4core.create('heat-map', am4charts.XYChart);
    ...
    return (
      <>
        <div className="section-line">
          <span className="title">USO DE ITENS/PERÍODO</span>
