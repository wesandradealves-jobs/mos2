...
class TableResize extends React.Component {
  ...
  setDividers = () => {
    ...
    finalCells.forEach(([key, item]) => {
      ...
      const left =
        resizeCoords[key] !== undefined ? resizeCoords[key].left : undefined;
    ...
    this.setState(
      { tableWidth, tableHeight, resizeCoords, priorPosition },
      this.updateWidths
    );
  };
...
export default withStyles(defaultResizeStyles, { name: 'MUIDataTableResize' })(
  TableResize
);
