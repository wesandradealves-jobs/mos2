...
import { ReactComponent as DownIcon } from '../icon/updownarrow.svg';
...
class TableHeadCell extends React.Component {
  ...
  render() {
    ...
    const sortActive = !!(
      sortDirection !== 'none' && sortDirection !== undefined
    );
    ...
    if (options.fixedHeaderOptions) {
      ...
      if (options.fixedHeaderOptions.xAxis)
        fixedHeaderClasses += ` ${classes.fixedHeaderXAxis}`;
      if (options.fixedHeaderOptions.yAxis)
        fixedHeaderClasses += ` ${classes.fixedHeaderYAxis}`;
    }
